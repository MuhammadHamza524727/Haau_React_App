...
//   return (
//     <nav className="bg-white  max-w-8xl mx-auto sticky top-0 z-50">
...
//               <img src="/src/assets/images/logo-remove.png" alt="logo-remove.png" height={100} width={100} />
//             </FadeContent>
//             <SearchBar />
//           </div>
  ...
  return (
    <nav className="bg-white w-full sticky top-0 z-50 shadow">
      <div className="flex justify-between items-center h-16 px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center text-blue-500 font-bold text-lg">
          <FadeContent blur={true} duration={1000} easing="ease-out" initialOpacity={0}>
            <img src="/src/assets/images/logo-remove.png" alt="logo-remove.png" height={100} width={100}  className='w-[50px] h-[50px] sm:w-[100px] sm:h-[80px]'/>
